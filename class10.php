...
<body>
  ...
  <div class="div_section3">
    <img src="image/class10/english.jpg" alt="xyz">
      <h1>English</h1>
  </div>

  <div class="div_section3">
    <img src="image/class10/urdu.jpg" alt="xyz">
    <h1>Urdu</h1>
  ...
  <div class="div_section3">
    <img src="image/class10/math.jpg" alt="xyz">
    <h1>Math</h1>
  </div>
        <br>
        <br>
        ...
        <br>
    <div class="div_section3">
    <img src="image/class10/bio.jpg" alt="xyz">
    <h1>Biology</h1>
  </div>
    <div class="div_section3">
    <img src="image/class10/computer.jpg" alt="xyz">
    <h1>Computer</h1>
  </div>
    <div class="div_section3">
    <img src="image/class10/computer.jpg" alt="xyz">
    <h1>Chemistry</h1>
        ...
        <br>
        <div class="div_section3">
    <img src="image/class10/phy.jpg" alt="xyz">
    <h1>Physics</h1>
  </div>
        <div class="div_section3">
    <img src="image/class10/islamiyat.jpg" alt="xyz">
    <h1>Islamiyat</h1>
  </div>
        <br>
</section>
