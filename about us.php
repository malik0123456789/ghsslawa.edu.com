     ...
     <div class="container">
        <div class="row">
            <div class="col-sm-14">
                <div class="row">
                    <div class="col-sm-12">
                        <h7 class="heading-about" > OUR AIMS & OBJECTIVES </h7>
                        <br>
                        <br>
                        <p>1. To develop the potential of every Boy's chlid in all aspects and          make them educated in the true sense of the word.
                            <br>
                            2. To provide an enriched and open envionment for higher level        interaction.
                            <br>
                            3. To maintain a higher degree of discipline.
                            <br>
                            4. To impact critical skills rather than giving a lot of information</p>
                    </div>
    <br>
    <br>
    <br>
