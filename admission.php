...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="container">
        <div class="col">
            <div class="col-sm-50">
                <h9>ADMISSION PROCEDURE</h9>
                <p class="text-mission-vission"> Government Higher Secondary School offers admissions to class 6th, 7th, 8th,9th,10th,11th,12th. Class 11th & Class 12th only F.A not F.sc are availability. </p>
                <h10>Obtaining the application form</h10>
                <p>Fill the application form online 
                <div class="Big"><a href="login.php">login page</a></div>
                and print the appliction from to submit the Government Higher Sceondary School Lawa</p>
                <h10>Criteria for Submission of the application form</h10>
                <p>
                The completed the application form must be submitted in School Office. The following documents should accompany the form.
                    <br>
                . Copy of School certificate
                    <br>
                . 4 Copy of B.form/CNIC
                    <br>
                . 4 Copy of passport size photo background color is blue
                    <br>
                .  4 copy of school degree
                    <br>
                .  4 Copy of Father CNIC
                </p>
            </div>
        </div>
