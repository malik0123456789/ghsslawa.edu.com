...
<body>
  ...
  <div class="div_section3">
    <img src="image/class8/english.jpg" alt="xyz">
      <h1>English</h1>
  </div>

  <div class="div_section3">
    <img src="image/class8/urdu.jpg" alt="xyz">
    <h1>Urdu</h1>
  ...
  <div class="div_section3">
    <img src="image/class8/math.jpg" alt="xyz">
    <h1>Math</h1>
  </div>
        <br>
        <br>
        ...
        <br>
    <div class="div_section3">
    <img src="image/class8/science.jpg" alt="xyz">
    <h1>Science</h1>
  </div>
    <div class="div_section3">
    <img src="image/class8/islamiyat.jpg" alt="xyz">
    <h1>Islamiyat</h1>
  </div>
    <div class="div_section3">
    <img src="image/class8/pakistan%20study.jpg" alt="xyz">
    <h1>Social Study</h1>
  </div>
</section>
    <br>
