...
<body>
  ...
  <div class="div_section3">
    <img src="image/class9/english.jpg" alt="xyz">
      <h1>English</h1>
  </div>

  <div class="div_section3">
    <img src="image/class9/urdu.jpg" alt="xyz">
    <h1>Urdu</h1>
  ...
  <div class="div_section3">
    <img src="image/class9/math.jpg" alt="xyz">
    <h1>Math</h1>
  </div>
        <br>
        <br>
        ...
        <br>
    <div class="div_section3">
    <img src="image/class9/bio.jpg" alt="xyz">
    <h1>Biology</h1>
  </div>
    <div class="div_section3">
    <img src="image/class9/computer.jpg" alt="xyz">
    <h1>Computer</h1>
  </div>
    <div class="div_section3">
    <img src="image/class9/computer.jpg" alt="xyz">
    <h1>Chemistry</h1>
        ...
        <br>
        <div class="div_section3">
    <img src="image/class9/phy.jpg" alt="xyz">
    <h1>Physics</h1>
  </div>
        <div class="div_section3">
    <img src="image/class9/pakstudy.jpg" alt="xyz">
    <h1>Social Study</h1>
  </div>
        <br>
</section>
